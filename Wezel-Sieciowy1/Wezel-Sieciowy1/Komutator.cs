    ...
    public class Komutator
    {
        ...
        private void Krosuj()
        {
            ...
            while (connected)
            {
                ...
                {
                    data.Send_Data(ReplaceHeader(pakiet, header, portOut, deltaLambda));
                }
                portOut = 0;
            }
        ...
        private String ReplaceHeader(String pakiet, String[] header, int portOut, int deltaLambda)
        {
            ...
            pakiet = pakiet.Remove(0, 10).Insert(0, newHeader.ToString());
            return pakiet;
        }


        public void SetConnect(int portIn, int portOut, int f1, int f2, int idP)        //dopisuje regule do tablicy kierowania connTable
        {
        ...
        public void Disconnect(int portIn, int f1) //po poleceniu disconnect od agenta(od SZ) zeruje dany wiersz connTable
        {
            int idP = 0;
